...
/**
 * The exception used by the test definition components.
 */
public class TestDefinitionException extends BundleAwareException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a default exception.
     */
    public TestDefinitionException() {
        // default constructor
    }
     ...
     */
    public TestDefinitionException(String messageID) {
        super(messageID);
    }
     ...
     */
    public TestDefinitionException(String messageID, Object... params) {
     ...
     */
    public TestDefinitionException(String messageID, Throwable cause) {
     ...
     * @param params    the parameters to use to fill in the message tokens
     */
    public TestDefinitionException(String messageID, Throwable cause, Object... params) {
     ...
     * @param cause the exception that triggered the creation of this exception
     */
    public TestDefinitionException(Throwable cause) {
        super(cause);
    }
