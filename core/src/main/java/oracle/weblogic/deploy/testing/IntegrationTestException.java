...
/**
 * The exception used during the execution of an integration test.
 */
public class IntegrationTestException extends BundleAwareException {
     ...
     */
    public IntegrationTestException(String messageID) {
        super(messageID);
    }
     ...
     */
    public IntegrationTestException(String messageID, Object... params) {
     ...
     */
    public IntegrationTestException(String messageID, Throwable cause) {
     ...
     * @param params    the parameters to use to fill in the message tokens
     */
    public IntegrationTestException(String messageID, Throwable cause, Object... params) {
